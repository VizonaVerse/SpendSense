    ...
    <div className="learn-page">
      ...
      <section className="learn-section">
        ...
        <div className="learn-text">
          ...
          <p>Once you receive a payslip, don’t just ignore it — take a moment to go through the key sections and check:</p>
          <ul>
          ...
          <p>
            If something doesn’t look right, speak to your employer or HR team — mistakes happen more often than you think!
            Keeping track of your payslips also helps when applying for loans, renting a flat, or understanding how your income changes over time.
          </p>
          <p>
